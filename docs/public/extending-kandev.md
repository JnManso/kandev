...
For a local CLI, users can choose **Settings → Agents → Add TUI Agent** and pick Terminal or ACP. That path persists a custom definition and default profile; no source patch is required.
